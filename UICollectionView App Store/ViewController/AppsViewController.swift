...
class AppsViewController: UIViewController {
    ...
    func createDataSource() {
        ...
        dataSource?.supplementaryViewProvider = { [weak self] collectionView, kind, indexPath in
            ...
            guard let section = self?.dataSource?.snapshot()
                    .sectionIdentifier(containingItem: firstApp) else {
                return nil
            }
    ...
    func createSmallTableSection(using section: Section) -> NSCollectionLayoutSection {
        ...
        let layoutGroupSize = NSCollectionLayoutSize(widthDimension: .fractionalHeight(0.93), heightDimension: .estimated(200))
        let layoutCroup = NSCollectionLayoutGroup.vertical(layoutSize: layoutGroupSize, subitems: [layoutItem])
        let layoutSection = NSCollectionLayoutSection(group: layoutCroup)
    ...
    func createSectionHeader() -> NSCollectionLayoutBoundarySupplementaryItem {
        let layoutSectionHeaderSize = NSCollectionLayoutSize(widthDimension: .fractionalHeight(0.93), heightDimension: .estimated(80))
